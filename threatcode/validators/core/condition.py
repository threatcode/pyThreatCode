...
from threatcode.conditions import ConditionIdentifier, ConditionItem, ConditionSelector
from threatcode.rule import ThreatcodeDetections, ThreatcodeRule
...
@dataclass
class DanglingDetectionIssue(ThreatcodeValidationIssue):
...
class DanglingDetectionValidator(ThreatcodeRuleValidator):
    ...
    def condition_referenced_ids(
        ...
        :type detections: ThreatcodeDetections
...
@dataclass
class ThemConditionWithSingleDetectionIssue(ThreatcodeValidationIssue):
...
class ThemConditionWithSingleDetectionValidator(ThreatcodeRuleValidator):
...
@dataclass
class AllOfThemConditionIssue(ThreatcodeValidationIssue):
...
class AllOfThemConditionValidator(ThreatcodeRuleValidator):
