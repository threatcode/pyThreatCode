...
from threatcode.conditions import ParentChainMixin
import threatcode
...
class DeferredTextQueryExpression(DeferredQueryExpression):
    ...
    * template: a string template containing the following placeholders:
      * field: the field name referenced by the Threatcode rule
      * value: the value from the Threatcode rule
