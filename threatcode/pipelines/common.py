...
from threatcode.processing.pipeline import ProcessingItem
from threatcode.processing.transformations import AddConditionTransformation

windows_logsource_mapping = {  # Mapping between Threatcode log source services and Windows event log channel names
    "security": "Security",
...
def generate_windows_logsource_items(
    ...
    * service: Threatcode log source definition field 'service'. Example: security
    * source: Windows log source name. Example: Microsoft-Windows-Sysmon/Operational
    ...
    :return: List of ProcessingItem that can be used in the items attribute of a ProcessingPipeline
        object. Usually, an additional field name mapping between the Threatcode taxonomy and the target
