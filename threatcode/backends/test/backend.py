...
from threatcode.conversion.base import TextQueryBackend
from threatcode.conversion.state import ConversionState
from threatcode.pipelines.test import dummy_test_pipeline
from threatcode.processing.pipeline import ProcessingItem, ProcessingPipeline
from threatcode.processing.transformations import FieldMappingTransformation
from threatcode.types import ThreatcodeCompareExpression
...
class TextQueryTestBackend(TextQueryBackend):
    ...
    compare_operators: ClassVar[Dict[ThreatcodeCompareExpression.CompareOperators, str]] = {
